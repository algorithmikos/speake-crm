...
function StudentInfo() {
  ...
  return (
    <>
      <h2 className="m-3">Single Student Information</h2>
      <hr />
      <form onSubmit={handleSubmit}>
        <div className="form-group row mb-3">
          <label
            htmlFor="studentName"
            className="col-sm-2 col-form-label label-font text-start"
          >
            Student Name
          </label>
        ...
        <div className="form-group row mb-3">
          <label className="col-sm-2 col-form-label label-font text-start">
            Action
          </label>
          <div className="col-sm-5">
